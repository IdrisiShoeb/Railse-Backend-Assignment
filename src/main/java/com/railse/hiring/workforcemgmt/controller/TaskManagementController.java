...
public class TaskManagementController {
    ...
    public Response<List<TaskManagementDto>> updateTaskPriority(@RequestBody UpdatePriorityRequest request) {
        return new Response<>(taskManagementService.updateTaskPriorities(request));
    }
    ...
    public Response<TaskDetailsDto> getDetails(@PathVariable Long id) {
